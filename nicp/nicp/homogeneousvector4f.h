 ...
 *
 *  This class allows to creates and operates on homogeneous points. The
 * homogeneous corrdinates is specified via template.
 */
...
class HomogeneousVector4f : public Eigen::Vector4f {
 public:
  ...
  constexpr static const float wCoordinate = wCoordinate_;
  ...
  /**
   *  This constructor creates an homogeneous points with the values of the
   * input 3D vector.
   ...
   *  This constructor creates an homogeneous points with the values of the
   * input object.
   *  @param other is an Eigen::MatrixBase object used to initialize the
   * Homogeneous4fVector.
   */
  ...
  /**
   *  This methods implements the operator equal between an Homogeneous4fVector
   * and an Eigen::MatrixBase object.
   */
  template <typename OtherDerived>
  inline HomogeneousVector4f &operator=(
...
/** \typedef Point
 * \brief An Homogeneous4fVector where the homogeneous coordinates is equal
 * to 1.
 */
typedef HomogeneousVector4f<1> Point;

/** \typedef Normal
 * \brief An Homogeneous4fVector where the homogeneous coordinates is equal to
 * 0.
 */
